                ...
                scope.launch {
                    ...
                    viewModel.addNotification(
                        notification = Notification(
                            ...
                            message = "Welcome to MediKart🎇",
                            messageDetail = "We’re thrilled to have you on board! " +
                                    "Explore amazing crutch deals and start shopping now."
                        )
                    )
                    dialog?.dismissWithAnimation()
                    dialog = DialogHelper.showDialogSuccess(
                        context = context,
                        title = "Success",
                        textContent = "Welcome to MediKart",
                        onConfirm = {
    ...
    Box(
        ...
        Column(
            ...
            Button(
                ...
                Text(
                    fontFamily = poppinsFontFamily,
                    text = stringResource(R.string.login) + " to MediKart",
                    fontSize = 16.sp,
