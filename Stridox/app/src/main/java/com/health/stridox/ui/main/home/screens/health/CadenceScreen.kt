...
private val cadenceWeekSample = listOf(160f, 165f, 162f, 168f, 164f, 166f, 163f)
...
fun CadenceScreen(
    ...
    val panelRounded = Color(0xFFE0B0FF).copy(alpha = 0.16f) // Purple accent base
    val accent = Color(0xFFE0B0FF)
    val muted = Color(0xFF8C98A8)
    val purple = Color(0xFFE0B0FF) // main purple line
    ...
    // --- Dummy datasets ---
    // Week: 7 points
    val weekPoints = cadenceWeekSample

    // Day: 24 points (simulate hourly data)
    val dayPoints = List(24) { idx ->
        (150f + Random(idx).nextFloat() * 30f)
    }
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Column {
                            Text("Current Cadence", color = muted)
